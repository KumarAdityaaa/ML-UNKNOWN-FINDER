...
def test_rank_unknowns_preserves_paper_provenance():
    papers = [
        PaperRecord(
            paper_id="paper-123",
            title="A Study of Adaptive Attention",
            source="test",
            novelty_results=[
                NoveltyResult(
                    term="adaptive attention",
    ...
    assert ranked[0].paper_title == "A Study of Adaptive Attention"
    assert ranked[0].reason == "rare and specific technical concept"
